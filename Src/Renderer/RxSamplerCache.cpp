...
// void RxSamplerCache::CreateSamplersWithProperties(uint32 number_of_samplers, RxSamplerPackedPropertiesType
// properties)
// {
...
//         MakePackedProperties(RxSamplerFilter::eLinear, RxSamplerFilter::eLinear, RxSamplerFilter::eLinear));

//     CreateSamplersWithProperties(
//         RX_SAMPLER_CACHE_MAX_NEAREST,
//         MakePackedProperties(RxSamplerFilter::eNearest, RxSamplerFilter::eNearest, RxSamplerFilter::eNearest));

//     CreateSamplersWithProperties(
//         RX_SAMPLER_CACHE_MAX_LLN,
//         MakePackedProperties(RxSamplerFilter::eLinear, RxSamplerFilter::eLinear, RxSamplerFilter::eNearest));

//     CreateSamplersWithProperties(
//         RX_SAMPLER_CACHE_MAX_NNL,
//         MakePackedProperties(RxSamplerFilter::eNearest, RxSamplerFilter::eNearest, RxSamplerFilter::eLinear));
// }
