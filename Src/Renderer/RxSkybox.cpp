...
void RxSkyboxRenderer::Render(const RxCommandBuffer& cmd, const FxCamera& render_cam)
{
    ...
    // vkCmdPushConstants(cmd.CommandBuffer, SkyboxPipeline.Layout, VK_SHADER_STAGE_VERTEX_BIT, 0,
...
void RxSkyboxRenderer::CreateSkyboxPipeline()
{
    ...
    // // RxRenderPassCache::Handle rp_handle =
    // gRenderPassCache->Request(gRenderPassCache->GetRenderPassId(attachments));
